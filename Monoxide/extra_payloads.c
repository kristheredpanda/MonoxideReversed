...
)
{
	...
	SetWindowTextW( hwnd, L"You shouldn't of done that." );
	return TRUE;
}
...
MessageBoxThread( VOID )
{
	...
	MessageBoxW( NULL, L"You shouldn't of done that.", L"You shouldn't of done that.", MB_ABORTRETRYIGNORE | MB_ICONERROR );
